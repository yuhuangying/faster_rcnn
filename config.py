...
trainset_root_path = 'D:/workspace/datasets/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/'
testset_root_path = 'D:/workspace/datasets/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/'
rng_seed = 3
...
checkpoint_name = 'fasterrcnn_r50'
pre_train = True
clip_grad = True
work_dir = './work_dir'
load_from = None #'./work_dir/fasterrcnn_r50-19.pth'
truncated = False

image_max_size = 1000
image_min_size = 600
#300*500 600*1000 s=2
#300*400 600*800  s=2
#600*400 900*600  s=1.5
