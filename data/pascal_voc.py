...
if __name__ == '__main__':
    train_set = PASCAL_VOC('D:/workspace/datasets/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/', 'trainval')
    dataloader = DataLoader(train_set, batch_size=1, shuffle=True, num_workers=2)
    print(len(train_set))
